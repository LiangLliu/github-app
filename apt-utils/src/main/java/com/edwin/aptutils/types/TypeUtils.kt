...
fun TypeMirror.simpleName() =
    TypeUtils.doubleErasure(this).let { name -> name.substring(name.lastIndexOf(".") + 1) }
...
//region TypeMirror
fun TypeMirror.asElement(): Element = AptContext.types.asElement(this)
