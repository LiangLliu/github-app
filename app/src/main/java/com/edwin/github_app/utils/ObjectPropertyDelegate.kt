...
fun <T> delegateOf(
    setter: ((T) -> Unit)? = null,
    defaultValue: T? = null
): ReadWriteProperty<Any, T> = ObjectPropertyDelegateNoGetter0(setter, defaultValue)
...
fun <T, R> KFunction1<R, T>.delegator(
    receiver: R,
    defaultValue: T? = null
): ReadWriteProperty<Any, T> = ObjectPropertyDelegate1(receiver, this, defaultValue = defaultValue)
