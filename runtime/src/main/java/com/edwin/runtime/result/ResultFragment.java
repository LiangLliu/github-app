...
public class ResultFragment extends Fragment {
    public static final String TAG = "com.edwin.activitybuilder.ResultFragment";
    public static final String SAVE_STATE_KEY = "com.edwin.activitybuilder.ResultFragment.SaveState";
