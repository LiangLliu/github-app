...
import com.edwin.runtime.ActivityBuilderCallback;
import com.edwin.runtime.result.ListenerEnvironment;
import com.edwin.runtime.result.ResultFragment;
...
public class ActivityBuilder {
    ...
    public static Bundle makeSceneTransition(Context context, ArrayList<Pair<View, String>> sharedElements) {
        if (context instanceof Activity) {
            ...
            return ActivityOptionsCompat.makeSceneTransitionAnimation(activity, sharedElements.toArray(new Pair[0]))
                    .toBundle();
        } else {
            return null;
        }
